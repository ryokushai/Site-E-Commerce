...
<div id="page-wrapper">
    ...
    <div class="row">
        <h3 style="text-align: center;padding-bottom: 30px;">Delete a Customer</h3>
    </div>
<form class="form-horizontal" action="delete.php" method="post">
<input type="hidden" name="id" value="<?php echo $id;?>" >
<p class="alert alert-error">Are you sure to delete?</p>
<div class="form-actions">
<button type="submit" class="btn btn-danger"><span class="icon-ok"></span> Yes</button>
<a class="btn" href="index.php">No</a>  </div>
    </form>
