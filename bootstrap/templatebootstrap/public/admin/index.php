        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        $sttm = $pdo->query('SELECT count(*) as test from checkout ');
                        while($item = $sttm->fetch()){
                                $ctte = $item['test'];
                                echo $ctte;
                        }
                        ?></div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        $stm = $pdo->query('SELECT count(*) as test from produit ');
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        $statement = $pdo->query('SELECT count(*) as test from categories ');
