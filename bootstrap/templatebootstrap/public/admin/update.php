...
$sql = "UPDATE users SET user_name=?,password=?,first_name=?,last_name=?,user_role=? where user_id=?" ;
$q = $pdo->prepare($sql);
$q->execute(array($user_name,$password,$first_name,$last_Name,$user_role,$idd)); 
