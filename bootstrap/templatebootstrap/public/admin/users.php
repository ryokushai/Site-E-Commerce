                            ...
                            $res = <<<EOF
                             <tr>
                                       ...
                                       <td><div class="action_links">
                                                ...
                                                <a class="btn btn-danger" href="delete.php?id=$id"><span class="icon-remove"></span>Delete</a>
                                                <a class="btn btn-success" href="update.php?id=$id"><span class="icon-edit"></span>Update</a>
